...
#### 7. Отклонение сервисом кредитования (Credit Gate) не действующей карты при вводе валидных данных 
Шаги:
1.	Нажать кнопку «Купить в кредит»
2.	В поле «Номер карты» ввести валидное значение не действующей карты.
3.	В поле «Месяц» ввести валидное значение.
...
#### 27. Отправка данных в БД в сервисе оплаты (Payment Gate) при вводе не валидного значения в поле «Месяц» (значение больше 1), остальные поля валидные
Шаги:
1.	Нажать кнопку «Купить»
2.	Ввести в поле «Номер карты» валидное значение
3.	Ввести в поле «Месяц» значение больше 1, например, «00»
4.	Ввести в поле «Год» валидное значение
5.	Ввести в поле «Владелец» валидное значение
6.	Ввести в поле «CVC/CVV» валидное значение
7.	Нажать кнопку «Продолжить»
...
#### 28. Отправка данных в БД в сервисе кредитования (Credit Gate) при вводе не валидного значения в поле «Месяц» (значение больше 1), остальные поля валидные
Шаги:
1.	Нажать кнопку «Купить в кредит»
2.	Ввести в поле «Номер карты» валидное значение
3.	Ввести в поле «Месяц» значение больше 1, например, «00»
...
Шаги:
8.	Нажать кнопку «Купить»
9.	Ввести в поле «Номер карты» валидное значение
10.	Ввести в поле «Месяц» валидное значение
11.	Ввести в поле «Год» число больше 23, например, значение «22»
12.	Ввести в поле «Владелец» валидное значение
13.	Ввести в поле «CVC/CVV» валидное значение
